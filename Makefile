...
#    Updated: 2022/09/17 02:29:42 by maolivei         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCE_FILES		+= command_execution.c set_io.c free.c enviroment_variable.c signal.c heredoc.c
...
SOURCE_FILES		+= syntax_error.c set_wstatus.c
